...
export const INHOUSE_AGENTS: InhouseAgentDef[] = [
  {
    ...
    usedAt: "Default for every module listing (override per screen in the Agent dropdown)",
  ...
  },
  {
    ...
    usedAt: "Default for left-rail workspace sparkle",
  ...
  },
  {
    ...
    usedAt: "Default for Fields, Form layout, Overview builder, Widgets, and Charts studios",
  ...
  },
  {
    ...
    usedAt: "Default for module Blueprint canvas (plus the blueprint builder panel)",
